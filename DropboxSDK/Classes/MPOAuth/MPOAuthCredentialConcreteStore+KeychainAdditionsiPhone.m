...
//	NSString *itemID = [NSString stringWithFormat:@"%@.oauth.%@", [[NSBundle mainBundle] bundleIdentifier], inName];
	...
	status = SecItemCopyMatching((__bridge CFDictionaryRef)searchDictionary, &dictDummy);
    attributesDictionary = (__bridge_transfer NSDictionary *)(dictDummy);
