...
- (void)connection:(NSURLConnection *)connection didReceiveData:(NSData *)data {
    ...
    if (responseBodySize > 0) {
        ...
        if (downloadProgressSelector) {
            IMP imp = [target methodForSelector:downloadProgressSelector];
            void(*func)(id, SEL, id) = (void *)imp;
            func(target, downloadProgressSelector, self);
        }
    }
}
...
#if 1
        IMP imp = [target methodForSelector:uploadProgressSelector];
        void(*func)(id, SEL, id) = (void *)imp;
        func(target, uploadProgressSelector, self);
#else
